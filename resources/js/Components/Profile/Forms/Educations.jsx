...
export default function EducationForm({user, onSuccess, submitButtonLabel}){
            ...
            {data?.education?.length > 0 && data.education.map((edu, i) => {
                return (
                    <div className="grid gap-4 grid-cols-12 p-2 mb-4 border-b" key={i}>
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="name">Course name</label>
                        ...
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="institute_name">Institute Name</label>
                        ...
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="started_at">Started At</label>
                        ...
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="ended_at">Ended At</label>
                        ...
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="obtained_score">Ontained marks </label>
                        ...
                        <div className="col-span-6 mb:col-span-4 lg:col-span-2 ">
                            <div className="form-control">
                                <label className="text-sm" htmlFor="max_score">Max marks </label>
